// JAVA THREADING PRACTICE

package in_2023_09_06;

public class BurgerMaker {

    public void toastBuns() throws InterruptedException {
        try {
    ...
    public static Runnable wrapRunnable(RunnableThrowing runnable) {
        return () -> {
            try {
                runnable.run();
            } catch (InterruptedException e) {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Thread t1 = new Thread(wrapRunnable(burgerMaker::toastBuns));
        Thread t2 = new Thread(wrapRunnable(burgerMaker::grillPatty));
        Thread t3 = new Thread(wrapRunnable(burgerMaker::meltCheese));
        Thread t4 = new Thread(wrapRunnable(burgerMaker::fryOnions));
        Thread t5 = new Thread(wrapRunnable(burgerMaker::assembleBurger));
