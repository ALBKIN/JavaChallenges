...
public class IceCreamShop {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Hello! Welcome to the ice cream shop. We are ready to take your order. For ice-cream type 1, " +
                "for shakes type 2, for smoothies type 3, and for slushies type 4. If you are done ordering type 0.");
